...
def get_rank_order(x):
    ...
    ascending = x.name in ('cross_entropy', 'digital_wage_error_rate')
...
def display_model_comparison(comp_models, 
    ...
    disp_types = {'max': ['accuracy', 'recall', 'precision', 'f1', 'roc_auc', 'cohen_kappa'], 
                  'min': ['cross_entropy']}
#     if show_dig_rate_error == True:
#         disp_metrics.append('digital_wage_rate_error')
#         disp_types['abs_min'] = ['digital_wage_rate_error']
